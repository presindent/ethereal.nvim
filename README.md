...
Ethereal is a, well, ethereal dark theme for Neovim 0.7.2 and older. It started as the good-old [Tokyodark theme](https://github.com/tiagovla/tokyodark.nvim) which I switched to quite a while ago, but I modified all of its palette with time, and this is what it all has culminated to.
